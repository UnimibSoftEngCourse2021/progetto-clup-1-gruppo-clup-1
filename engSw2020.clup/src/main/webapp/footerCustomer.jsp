	...
	<ul class="r-footer">
		<li class="features">
			...
			<ul class="box h-box">
				...
				<li><a href="http://localhost:8080/clup/customerBooking.jsp">Gestione prenotazioni</a></li>
				<li><a href="http://localhost:8080/clup/customerInformation.jsp">Gestione account</a></li>
