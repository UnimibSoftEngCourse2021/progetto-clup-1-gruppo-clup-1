...
<body>
	<div class="testbox">
		<form id="editform" action="ModifyServlet" class="formContainer"
			method="post" onsubmit="return validateDate();">
			<fieldset>
				<legend>Booking Information</legend>
				<div class="item">
					<input id="idBooking" type="hidden" name="idBooking"
						value="<%=request.getParameter("idBooking")%>" />
				</div>
				<div class="item">
					<label for="bookingDate">Data Prenotazione <span>*</span></label> <input
						id="datepicker" type="date" name="date" /> <i
