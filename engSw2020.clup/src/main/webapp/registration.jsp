...
<body>
    <div class="main-content">
        ...
        <form class="form-register" action="registrationServlet" method="post" onsubmit="return validate();">
            ...
            <div class="form-register-with-email">
                ...
                <a href="index.jsp" class="form-log-in-with-existing">Hai già un account? <b> Accedi </b></a>
