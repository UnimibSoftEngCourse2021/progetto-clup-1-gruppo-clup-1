		...
		try {
			...
			if (idRole == 1) {
				...
				try {
					...
					int result = 0;
					result = userDao.modifyUserInfo(idUser, name, surname, email, userName, telephoneNumber,
							birthdayDate);
					if (result == 1) {
				...
				try {
					...
					result = userDao.modifyCustomerUserInfo(idUser, name, surname, email, userName, telephoneNumber,
							birthdayDate, password);
					if (result == 1) {
						request.setAttribute("iduser", idUser);
